...
SELECT vendor_id, count(1) AS rented_count
...
*/
-- DROP TABLE IF EXISTS temp.new_vendor; -- So we can rerun all the SQL commands multiple times
...
-- GROUP BY customer_id, STRFTIME('%Y-%m', market_date)
;
